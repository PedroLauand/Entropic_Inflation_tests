"""Compute all seven triangle-inequality lower bounds in the complementary spiral LP.

This is the same calculation as the clockwise spiral example, but for the
complementary winding direction.
"""
...
def solve_bound(name: str, description: str, certificate: dict[str, float]) -> dict[str, object]:
    """Minimize one triangle inequality over the complementary observed-only spiral LP."""
    lp = InflationLP(triangle_complementary_spiral_problem(), include_latents=False)
    lp.set_extra_equalities(triangle_complementary_spiral_equalities())
    lp.set_objective(
...
if __name__ == "__main__":
    ...
    print("scenario:", "triangle complementary spiral")
